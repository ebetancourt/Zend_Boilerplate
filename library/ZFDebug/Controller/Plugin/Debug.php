...
class ZFDebug_Controller_Plugin_Debug extends Zend_Controller_Plugin_Abstract
{
        ...
        return ('
            ...
            <script type="text/javascript" charset="utf-8">
                ...
                window.onload = function(){
                    ...
                    // jQuery.noConflict();  * See http://code.google.com/p/zfdebug/issues/detail?id=30
                    ZFDebugCollapsed();
                };
    ...
    protected function _output($html)
    {
        ...
        $response->setBody(preg_replace('/(<head>|<head .*>)/i', '$1' . $this->_headerOutput(), $response->getBody()));
